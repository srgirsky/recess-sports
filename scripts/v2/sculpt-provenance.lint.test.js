...
const GOVERNED = [
  ...
  { id: 'zippy', script: 'sculpt-zippy-source.py' },
  ...
  { id: 'penny', script: 'sculpt-penny-source.py' },
  { id: 'the_prof', script: 'sculpt-the-professor-source.py' },
  { id: 'ace_kid', script: 'sculpt-ace-source.py' },
  { id: 'rocket', script: 'sculpt-rocket-rosa-source.py' },
  { id: 'gizmo', script: 'sculpt-gizmo-source.py' },
  { id: 'dex', script: 'sculpt-dex-source.py' },
  { id: 'clover', script: 'sculpt-clover-source.py' },
  { id: 'boomer', script: 'sculpt-boomer-source.py' },
  { id: 'smokey', script: 'sculpt-smokey-source.py' },
  { id: 'sniffles', script: 'sculpt-sniffles-source.py' },
  { id: 'cricket', script: 'sculpt-cricket-source.py' },
  { id: 'peaches', script: 'sculpt-peaches-source.py' },
  { id: 'lefty', script: 'sculpt-lefty-source.py' },
  { id: 'mimi_mash', script: 'sculpt-mimi-mash-source.py' },
  { id: 'calls_shot', script: 'sculpt-theo-source.py' },
  { id: 'wheelchair_ace', script: 'sculpt-zoom-source.py' },
  { id: 'big_lou', script: 'sculpt-big-lou-source.py' },
];
