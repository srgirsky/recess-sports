...
| `scripts/v2/validate-models.test.js` / `authored-character.test.js` / `arm-skinning.test.js` / `reference-hands.test.js` | a `.glb` breaking its contract, Blender source, joints, finger caps or visual approval |
