...
| `scripts/v2/validate-models.test.js` / `authored-character.test.js` / `arm-skinning.test.js` | a `.glb` breaking its contract, Blender source, joint blending or visual approval |
